 ...
 * PNG the vision model and the image model fetch, a rail thumbnail, and a small
 * JPEG for the vision call. Sending a full-size PNG to the vision model would
 * cost far more tokens for no extra information.
 *
 * The blot is never replayed a beat at a time: it is a reference the film shows
 * for a moment, so the intermediate frames were work nobody looked at.
 */
